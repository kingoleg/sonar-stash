...
public class StashCommentReportTest {
    ...
    public void testNotContains() {
        ...
        assertFalse(report.contains("message1", "path1", 2));
    }
    ...
    public void testAddReport() {
        ...
        assertTrue(report2.contains("message1", "path1", 1));
        assertTrue(report2.contains("message2", "path2", 2));
        assertTrue(report2.contains("message3", "path3", 3));
        assertFalse(report2.contains("message4", "path4", 4));
    }
    ...
    public void applyDiffReportWithCONTEXT() {
        ...
        comment2 = new StashComment(987654, "message2", "path2", (long) 2, stashUser, 0);
