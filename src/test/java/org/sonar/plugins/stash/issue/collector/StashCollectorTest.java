...
public class StashCollectorTest {
    ...
    PullRequestRef pr = PullRequestRef.builder().setProject("project").setRepository("repository").setPullRequestId(123).build();
    ...
    public void testExtractPullRequest() throws Exception {
        ...
        String jsonBody = "{\"id\": " + pullRequestId + ", \"version\": " + pullRequestVersion + ", \"title\": \"PR-Test\","
                + "\"description\": \"PR-test\", \"reviewers\": [" + "{\"user\": { \"name\":\"" + reviewerName
                + "\", \"emailAddress\": \"" + reviewerEmail + "\"," + "\"id\": " + reviewerId + ", \"slug\": \"" + reviewerSlug
    ...
    public void testExtractPullRequestWithSeveralReviewer() throws Exception {
        ...
        String jsonBody = "{\"id\": " + pullRequestId + ", \"version\": " + pullRequestVersion + ", \"title\": \"PR-Test\","
                + "\"description\": \"PR-test\", \"reviewers\": [" + "{\"user\": { \"name\":\"" + reviewerName1
                + "\", \"emailAddress\": \"" + reviewerEmail1 + "\"," + "\"id\": " + reviewerId1 + ", \"slug\": \""
                + reviewerSlug1 + "\"}, \"role\": \"REVIEWER\", \"approved\": false}," + "{\"user\": { \"name\":\""
                + reviewerName2 + "\", \"emailAddress\": \"" + reviewerEmail2 + "\"," + "\"id\": " + reviewerId2
                + ", \"slug\": \"" + reviewerSlug2 + "\"}, \"role\": \"REVIEWER\", \"approved\": false}]}";
