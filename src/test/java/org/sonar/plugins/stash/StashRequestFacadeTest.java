...
public class StashRequestFacadeTest extends StashTest {
    ...
    public void setUp() throws Exception {
        ...
        Issue issue1 = new DefaultIssue().setKey("key1").setSeverity(Severity.CRITICAL).setMessage("message1")
                .setRuleKey(RuleKey.of("foo", "rule1")).setLine(1);
        ...
        Issue issue2 = new DefaultIssue().setKey("key2").setSeverity(Severity.MAJOR).setMessage("message2")
                .setRuleKey(RuleKey.of("foo", "rule2")).setLine(2);
        ...
        Issue issue3 = new DefaultIssue().setKey("key3").setSeverity(Severity.INFO).setMessage("message3")
                .setRuleKey(RuleKey.of("foo", "rule3")).setLine(1);
        ...
        /*
         * CoverageIssue coverageIssue = new CoverageIssue(Severity.MAJOR,
         * "sonar/coverage/file");
         * 
    ...
    public void testPostSonarQubeReportWithException() throws StashClientException {
        doThrow(new StashClientException("StashClientException for Test")).when(myFacade).postCommentPerIssue(eq(pr),
                anyCollectionOf(Issue.class), eq(diffReport), eq(stashClient));
    ...
    public void testPostSonarQubeReportWithExceptions() throws Exception {
        ...
        doThrow(new StashClientException("StashClientException for Test")).when(stashClient).postCommentLineOnPullRequest(pr,
    ...
    public void testGetPullRequestDiffReportWithException() throws Exception {
        doThrow(new StashClientException("StashClientException for Test")).when(stashClient).getPullRequestDiffs(pr);
